...
# Hello , I'm Ankith , an Aspiring Data Analyst  👋🏼:
...
1. [Skills and Tools](#Tools-i-use)
2. [Projects](#2-Projects)  , [Dashboard](#2-dashboard) , [SQL -Queries](#2-SQL-queries)
...
#### 2. SQL-Queries
I have set up Postgres server using pgAdmin4 in my own laptop and queried data.
##### 1.[Top Paying Skills](https://github.com/ADR600/DataScience/blob/75d19404f48ca4d65cb92b50eae9aa0a3d1da467/Project/SQL/top_paying_job_skills.sql)
##### 2.[Top Paying Jobs](https://github.com/ADR600/DataScience/blob/75d19404f48ca4d65cb92b50eae9aa0a3d1da467/Project/SQL/top_paying_jobs.sql)
#### 3. Data Sources
